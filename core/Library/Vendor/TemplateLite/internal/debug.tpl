...
<SCRIPT language=javascript>
	...
	_templatelite_console.document.write("<tr bgcolor=#cccccc><td colspan=2><b>Included templates & setup files (load time in seconds):</b></td></tr>");
	{foreach key=key value=templates from=$_debug_tpls}
	...
	{/foreach}
	_templatelite_console.document.write("<tr bgcolor=#cccccc><td colspan=2><b>Assigned setup file variables (outer template scope):</b></td></tr>");
	{foreach key=key value=config_vars from=$_debug_config_keys}
		_templatelite_console.document.write("<tr bgcolor={if $key % 2}#eeeeee{else}#fafafa{/if}>");
	...
	{foreachelse}
		_templatelite_console.document.write("<tr bgcolor=#eeeeee><td colspan=2><tt><i>No setup vars assigned</i></tt></td></tr>");
	{/foreach}
