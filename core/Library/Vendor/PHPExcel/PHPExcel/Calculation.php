	...
	public function setLocale($locale = 'en_us') {
		...
		if (in_array($language,self::$_validLocaleLanguages)) {
			...
			if ($locale != 'en_us') {
				...
				$configFile = PHPEXCEL_ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.str_replace('_',DIRECTORY_SEPARATOR,$locale).DIRECTORY_SEPARATOR.'setup';
				if (!file_exists($configFile)) {
					$configFile = PHPEXCEL_ROOT . 'PHPExcel'.DIRECTORY_SEPARATOR.'locale'.DIRECTORY_SEPARATOR.$language.DIRECTORY_SEPARATOR.'setup';
				}
				if (file_exists($configFile)) {
