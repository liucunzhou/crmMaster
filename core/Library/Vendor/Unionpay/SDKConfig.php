...
// 签名证书路径
const SDK_SIGN_CERT_PATH = '/data/web/certs/acp_prod_sign.pfx';

// 签名证书密码
const SDK_SIGN_CERT_PWD = 'lichi';

// 密码加密证书（这条一般用不到的请随便配）
const SDK_ENCRYPT_CERT_PATH = '/data/web/certs/acp_prod_enc.cer';

// 验签证书路径（请配到文件夹，不要配到具体文件）
const SDK_VERIFY_CERT_DIR = '/data/web/certs/';
...
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_NOTIFY_URL = 'http://www.2used.cn/Callback/unionReturnUrl.html';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_NOTIFY_URL = 'http://www.2used.cn/Callback/unionNotifyUrl.html';
// 前台通知地址 (商户自行配置通知地址)
const SDK_FRONT_CNOTIFY_URL = 'http://www.2used.cn/Callback/unionChargeReturnUrl.html';

// 后台通知地址 (商户自行配置通知地址，需配置外网能访问的地址)
const SDK_BACK_CNOTIFY_URL = 'http://www.2used.cn/Callback/unionChargeNotifyUrl.html';

//文件下载目录 
const SDK_FILE_DOWN_PATH = '/data/web/file/';

//日志 目录 
const SDK_LOG_FILE_PATH = '/data/web/logs/';
