...
class Smarty_Internal_Data {
    ...
    /**
     * load a setup file, optionally load just selected sections
     *
    ...
    /**
     * gets  a setup variable
     *
     * @param string $variable the name of the setup variable
     * @return mixed the value of the setup variable
     */
    ...
    /**
     * Returns a single or all setup variables
     *
     * @param string $varname variable name or null
     * @return string variable value or or array of variables
     */
    ...
    /**
     * Deassigns a single or all setup variables
     *
     * @param string $varname variable name or null
     * @return Smarty_Internal_Data current Smarty_Internal_Data (or Smarty or Smarty_Internal_Template) instance for chaining
     */
