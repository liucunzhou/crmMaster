 ...
 * Smarty Internal Plugin Config
 *
 * Main class for setup variables
 *
 * @package Smarty
 * @subpackage Config
 *
...
class Smarty_Internal_Config {
    ...
    /**
     * filepath of compiled setup file
     *
     * @var string
     */
    public $compiled_filepath = null;
    /**
     * Filemtime of compiled setup Filemtime
     *
     * @var int
     */
    public $compiled_timestamp = null;
    /**
     * flag if compiled setup file is invalid and must be (re)compiled
     * @var bool
     */
    ...
    /**
     * Constructor of setup file object
     *
     * @param string $config_resource setup file resource name
     * @param Smarty $smarty Smarty instance
     * @param object $data object for setup vars storage
     */
    ...
    public function buildCompiledFilepath()
    {
        ...
        return $_compile_dir . $_filepath . '.' . basename($this->source->name) . '.setup' . '.php';
    }
    ...
    /**
     * Returns if the current setup file must be compiled
     *
     * It does compare the timestamps of setup Source and the compiled setup and checks the force compile configuration
     *
    ...
    /**
     * Returns the compiled setup file
     *
     * It checks if the setup file must be compiled or just read the compiled version
     *
     * @return string the compiled setup file
     */
    ...
    public function __set($property_name, $value)
    {
        ...
        throw new SmartyException("invalid setup property '$property_name'.");
    }
    ...
    public function __get($property_name)
    {
        ...
        throw new SmartyException("setup attribute '$property_name' does not exist.");
    }
