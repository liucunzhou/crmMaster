...
abstract class Smarty_Resource {
    ...
    protected function buildFilepath(Smarty_Template_Source $source, Smarty_Internal_Template $_template=null)
    {
        ...
        if ($_default_handler) {
            if (!is_callable($_default_handler)) {
                if ($source instanceof Smarty_Config_Source) {
                    throw new SmartyException("Default setup handler not callable");
                } else {
    ...
    public static function load(Smarty $smarty, $type)
    {
        ...
        // TODO: try default_(template|setup)_handler
     ...
     *
     * @param Smarty_Internal_Config $_config setup object
    ...
    public static function config(Smarty_Internal_Config $_config)
    {
        ...
        if (isset($_incompatible_resources[$type])) {
            throw new SmartyException ("Unable to use resource '{$type}' for setup");
        }
        ...
        // check runtime cache
        $_cache_key = 'setup|' . $unique_resource_name;
        if (isset(self::$sources[$_cache_key])) {
            return self::$sources[$_cache_key];
        }
