...
class Smarty extends Smarty_Internal_TemplateBase {
    ...
    */
    ...
    /**
    * joined setup directory string used in cache keys
    * @var string
    */
    ...
    */
    ...
    /**
    * Controls whether setup values of on/true/yes and off/false/no get converted to boolean.
    * @var boolean
    */
    public $config_booleanize = true;
    /**
    * Controls whether hidden setup sections/vars are read from the file.
    * @var boolean
    */
    ...
    */
    ...
    /**
    * Add setup directory(s)
    *
    * @param string|array $config_dir directory(s) of setup sources
    * @param string key of the array element to assign the setup dir to
    * @return Smarty current Smarty instance for chaining
    */
